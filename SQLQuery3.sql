...
('Lê Thị Oanh', '2011-11-18', 0, 'Grade 7', 3, GETDATE(), GETDATE()),

-- Con của Phạm Thị Dung
('Phạm Văn Phúc', '2010-09-30',1, 'Grade 8', 4, GETDATE(), GETDATE()),
('Phạm Thị Quỳnh', '2012-02-14', 0, 'Grade 6', 4, GETDATE(), GETDATE()),

-- Con của Hoàng Văn Em
('Hoàng Minh Tuấn', '2008-12-03',1, 'Grade 10', 5, GETDATE(), GETDATE()),
('Hoàng Thị Vân', '2011-06-25', 0, 'Grade 7', 5, GETDATE(), GETDATE()),

-- Con của Vũ Thị Hoa
('Vũ Đức Anh', '2010-04-17',1, 'Grade 8', 6, GETDATE(), GETDATE()),
('Vũ Thị Bảo', '2013-01-08', 0, 'Grade 5', 6, GETDATE(), GETDATE()),

-- Con của Đặng Văn Khải
('Đặng Thành Long', '2009-10-12',1, 'Grade 9', 7, GETDATE(), GETDATE()),
('Đặng Thị Mai', '2012-05-27', 0, 'Grade 6', 7, GETDATE(), GETDATE()),

-- Con của Bùi Thị Lan
('Bùi Văn Hùng', '2011-08-19',1, 'Grade 7', 8, GETDATE(), GETDATE()),
('Bùi Thị Nhung', '2013-03-16', 0, 'Grade 5', 8, GETDATE(), GETDATE()),

-- Con của Ngô Văn Minh
('Ngô Đình Tài', '2010-01-23',1, 'Grade 8', 9, GETDATE(), GETDATE()),
('Ngô Thị Yến', '2012-09-11', 0, 'Grade 6', 9, GETDATE(), GETDATE()),

-- Con của Đỗ Thị Nga
('Đỗ Minh Hiếu', '2009-11-07',1, 'Grade 9', 10, GETDATE(), GETDATE()),
('Đỗ Thị Xuân', '2011-04-02', 0, 'Grade 7', 10, GETDATE(), GETDATE());
...
-- Thứ 2
('Toán Nâng Cao A1', 'Mathematics', 1, '08:00:00', '09:30:00', 'Thầy Nguyễn Văn Phú', 20, GETDATE(), GETDATE()),
('Tiếng Anh Giao Tiếp B1', 'English', 1, '10:00:00', '11:30:00', 'Cô Sarah Johnson', 15, GETDATE(), GETDATE()),
('Lý Cơ Bản C1', 'Physics', 1, '14:00:00', '15:30:00', 'Thầy Lê Minh Tuấn', 18, GETDATE(), GETDATE()),
('Hóa Nâng Cao D1', 'Chemistry', 1, '16:00:00', '17:30:00', 'Cô Trần Thị Mai', 16, GETDATE(), GETDATE()),

-- Thứ 3
('Toán THCS A2', 'Mathematics', 2, '08:00:00', '09:30:00', 'Thầy Phạm Đức Anh', 22, GETDATE(), GETDATE()),
('Văn Học Thiếu Nhi B2', 'Literature', 2, '10:00:00', '11:30:00', 'Cô Nguyễn Thị Hoa', 20, GETDATE(), GETDATE()),
('Tiếng Anh Căn Bản C2', 'English', 2, '14:00:00', '15:30:00', 'Cô Emma Wilson', 18, GETDATE(), GETDATE()),
('Tin Học Văn Phòng D2', 'Computer Science', 2, '16:00:00', '17:30:00', 'Thầy Vũ Minh Khang', 12, GETDATE(), GETDATE()),

-- Thứ 4
('Lý Nâng Cao A3', 'Physics', 3, '08:00:00', '09:30:00', 'Thầy Hoàng Văn Nam', 15, GETDATE(), GETDATE()),
('Toán Tư Duy B3', 'Mathematics', 3, '10:00:00', '11:30:00', 'Cô Đặng Thị Lan', 25, GETDATE(), GETDATE()),
('Tiếng Anh IELTS C3', 'English', 3, '14:00:00', '15:30:00', 'Thầy Michael Brown', 10, GETDATE(), GETDATE()),
('Hóa Thực Hành D3', 'Chemistry', 3, '16:00:00', '17:30:00', 'Cô Bùi Thị Nga', 14, GETDATE(), GETDATE()),

-- Thứ 5
('Văn THCS A4', 'Literature', 4, '08:00:00', '09:30:00', 'Cô Lý Thị Vân', 20, GETDATE(), GETDATE()),
('Toán Hình Học B4', 'Mathematics', 4, '10:00:00', '11:30:00', 'Thầy Ngô Đức Minh', 18, GETDATE(), GETDATE()),
('Sinh Học Căn Bản C4', 'Biology', 4, '14:00:00', '15:30:00', 'Cô Phạm Thị Quỳnh', 20, GETDATE(), GETDATE()),
('Tiếng Anh Thiếu Nhi D4', 'English', 4, '16:00:00', '17:30:00', 'Cô Lisa Anderson', 16, GETDATE(), GETDATE()),

-- Thứ 6
('Lý Thí Nghiệm A5', 'Physics', 5, '08:00:00', '09:30:00', 'Thầy Trần Văn Hùng', 12, GETDATE(), GETDATE()),
('Hóa Phân Tích B5', 'Chemistry', 5, '10:00:00', '11:30:00', 'Cô Võ Thị Xuân', 15, GETDATE(), GETDATE()),
('Toán Ứng Dụng C5', 'Mathematics', 5, '14:00:00', '15:30:00', 'Thầy Đỗ Minh Tài', 20, GETDATE(), GETDATE()),
('Tiếng Anh Học Thuật D5', 'English', 5, '16:00:00', '17:30:00', 'Thầy James Wilson', 12, GETDATE(), GETDATE()),

-- Thứ 7
('Văn Sáng Tác A6', 'Literature', 6, '08:00:00', '09:30:00', 'Cô Nguyễn Thị Thu', 15, GETDATE(), GETDATE()),
('Toán Olimpic B6', 'Mathematics', 6, '10:00:00', '11:30:00', 'Thầy Lê Đức Thọ', 10, GETDATE(), GETDATE()),
('Lập Trình Scratch C6', 'Computer Science', 6, '14:00:00', '15:30:00', 'Thầy Phạm Minh Đức', 12, GETDATE(), GETDATE()),
('Tiếng Anh Phiên Dịch D6', 'English', 6, '16:00:00', '17:30:00', 'Cô Anna Taylor', 8, GETDATE(), GETDATE()),

-- Chủ nhật
('Toán Tổng Hợp A7', 'Mathematics', 0, '08:00:00', '09:30:00', 'Thầy Vũ Văn Thành', 25, GETDATE(), GETDATE()),
('Khoa Học Tự Nhiên B7', 'Science', 0, '10:00:00', '11:30:00', 'Cô Hoàng Thị Linh', 20, GETDATE(), GETDATE()),
('Kỹ Năng Mềm C7', 'Soft Skills', 0, '14:00:00', '15:30:00', 'Thầy Đặng Văn Long', 30, GETDATE(), GETDATE()),
('Tiếng Anh Tổng Quát D7', 'English', 0, '16:00:00', '17:30:00', 'Cô Jennifer Davis', 18, GETDATE(), GETDATE());
...
(2, 'Gói Premium 3 Tháng', '2024-01-01', '2024-03-31', 36, 8, 1, GETDATE(), GETDATE()),
(5, 'Gói Premium 6 Tháng', '2024-01-01', '2024-06-30', 72, 15, 1, GETDATE(), GETDATE()),
(9, 'Gói Premium 1 Năm', '2024-01-01', '2024-12-31', 144, 25, 1, GETDATE(), GETDATE()),
(13, 'Gói Premium 3 Tháng', '2024-02-01', '2024-04-30', 36, 12, 1, GETDATE(), GETDATE()),
(17, 'Gói Premium 6 Tháng', '2024-01-15', '2024-07-15', 72, 20, 1, GETDATE(), GETDATE()),
(19, 'Gói Premium 3 Tháng', '2024-03-01', '2024-05-31', 36, 5, 1, GETDATE(), GETDATE()),

-- Học sinh Grade 6-7 (Standard packages)
(2, 'Gói Standard 2 Tháng', '2024-01-01', '2024-02-29', 24, 18, 1, GETDATE(), GETDATE()),
(3, 'Gói Standard 3 Tháng', '2024-01-15', '2024-04-15', 36, 22, 1, GETDATE(), GETDATE()),
(6, 'Gói Standard 4 Tháng', '2024-02-01', '2024-05-31', 48, 30, 1, GETDATE(), GETDATE()),
(10, 'Gói Standard 2 Tháng', '2024-03-01', '2024-04-30', 24, 8, 1, GETDATE(), GETDATE()),
(15, 'Gói Standard 3 Tháng', '2024-01-01', '2024-03-31', 36, 28, 1, GETDATE(), GETDATE()),
(18, 'Gói Standard 2 Tháng', '2024-02-15', '2024-04-15', 24, 12, 1, GETDATE(), GETDATE()),
(20, 'Gói Standard 4 Tháng', '2024-01-01', '2024-04-30', 48, 35, 1, GETDATE(), GETDATE()),

-- Học sinh Grade 5 (Basic packages)
(4, 'Gói Basic 1 Tháng', '2024-01-01', '2024-01-31', 12, 12, 2, GETDATE(), GETDATE()),
(8, 'Gói Basic 2 Tháng', '2024-02-01', '2024-03-31', 24, 16, 1, GETDATE(), GETDATE()),
(12, 'Gói Basic 1 Tháng', '2024-03-01', '2024-03-31', 12, 8, 1, GETDATE(), GETDATE()),
(16, 'Gói Basic 2 Tháng', '2024-01-15', '2024-03-15', 24, 20, 1, GETDATE(), GETDATE()),

-- Một số gói đã hết hạn/suspended
(7, 'Gói Trial 2 Tuần', '2023-12-01', '2023-12-15', 6, 5, 0, GETDATE(), GETDATE()),
(11, 'Gói Standard 1 Tháng', '2023-12-01', '2023-12-31', 12, 8, 0, GETDATE(), GETDATE()),
